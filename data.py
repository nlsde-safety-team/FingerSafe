...
class DataSampler:
    ...
    def sample(self, flag=False):
        ...
        if flag:  # flag=true, then sample from all data. False, then sample from only test set
...
# DataSampler_adv: sample clean and adv pair from dataset
